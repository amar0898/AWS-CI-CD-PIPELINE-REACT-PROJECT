...
const ProfileCard = () => {
  const profile = {
    ...
    about: "Passionate about building scalable java applications and learning new technologies. Skilled in React, Spring Boot, AWS, and DevOps.",
    skills: ["React", "JavaScript", "Spring Boot", "AWS", "DevOps", "Terraform"],
